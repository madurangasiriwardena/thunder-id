...
var (
	...
	// queryTouchClientSession updates LAST_USED_AT for a CLIENT_SESSION.
	// Args: $1=LAST_USED_AT, $2=CLIENT_SESSION_ID, $3=DEPLOYMENT_ID
	queryTouchClientSession = dbmodel.DBQuery{
		ID: "SSQ-CSS-04",
		Query: `UPDATE "CLIENT_SESSION" SET LAST_USED_AT = $1 ` +
			`WHERE CLIENT_SESSION_ID = $2 AND DEPLOYMENT_ID = $3`,
	}
)
