...
func (_c *SessionServiceInterfaceMock_CreateSessionFromFlow_Call) Run(run func(ctx context.Context, in session.CreateSessionInput)) *SessionServiceInterfaceMock_CreateSessionFromFlow_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(session.CreateSessionInput))
	})
	return _c
}
...
func (_c *SessionServiceInterfaceMock_CreateSessionFromFlow_Call) RunAndReturn(run func(context.Context, session.CreateSessionInput) (*session.SessionRecord, error)) *SessionServiceInterfaceMock_CreateSessionFromFlow_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *SessionServiceInterfaceMock_ResolveSession_Call) RunAndReturn(run func(context.Context, *http.Request) (*session.SessionRecord, error)) *SessionServiceInterfaceMock_ResolveSession_Call {
	_c.Call.Return(run)
	return _c
}

// EnsureClientSession provides a mock function for the type SessionServiceInterfaceMock
func (_mock *SessionServiceInterfaceMock) EnsureClientSession(ctx context.Context, sessionID, clientID string, grantedScopes []string) (*session.ClientSession, error) {
...
func (_c *SessionServiceInterfaceMock_EnsureClientSession_Call) Run(run func(ctx context.Context, sessionID, clientID string, grantedScopes []string)) *SessionServiceInterfaceMock_EnsureClientSession_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *SessionServiceInterfaceMock_EnsureClientSession_Call) RunAndReturn(run func(context.Context, string, string, []string) (*session.ClientSession, error)) *SessionServiceInterfaceMock_EnsureClientSession_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *SessionServiceInterfaceMock_GetSessionByID_Call) RunAndReturn(run func(context.Context, string) (*session.SessionRecord, error)) *SessionServiceInterfaceMock_GetSessionByID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *SessionServiceInterfaceMock_GetClientSessionByID_Call) RunAndReturn(run func(context.Context, string) (*session.ClientSession, error)) *SessionServiceInterfaceMock_GetClientSessionByID_Call {
	_c.Call.Return(run)
	return _c
}
